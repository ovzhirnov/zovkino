...
{ ?>
Работаем с сайтом: http://grandefile.ru
...
while (strstr($rf,"style=\"font-size:12px;\"><strong><a href=\""))//начальная строка для поиска
{
$s1=strpos($rf,"style=\"font-size:12px;\"><strong><a href=\"",0);//начальная строка для поиска
$s2=strpos($rf,"\">Скачать",$s1);//конечная строка для поиска
$s=$s2-$s1;
...
$strneedle=array ("",">Год выхода</b>:",">Название</b>:",">Оригинальное название</b>:",">Жанр</b>:",">Режиссер</b>:",">В ролях</b>:",
">Продолжительность</b>:",">О фильме</b>:",">Качество</b>:",">Озвучивание</b>:",">Видео</b>:",">Аудио</b>:",">Размер</b>:");
...
$s1=strpos($rf,$strneedle[$i],0);
	if ($i==1 && !$s1) {$strneedle[$i]=">Год выпуска:"; $s1=strpos($rf,$strneedle[$i],0);
}
if ($s1)
{
...
$zz=strrpos($picurl,"/");
$picurl="poster1".substr($picurl,$zz);//готовый относительный адрес картинки
