...
if ($_SESSION['name']) //если был запрос на запись данных о фильме
{
...
else {echo "<font color='#FF0000'>картинки ".$link." не существует</font><br>";}
...
$s=strpos($ourletiturl,"/",0);
$ourletiturl=substr($ourletiturl,++$s,strlen($ourletiturl));
